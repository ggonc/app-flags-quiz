...
public class Pergunta05 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNumeroPergunta.setText("5/10");
    ...
    public void responder(View view){
        ...
        if (radioButton.getText().equals("Islândia")){
            acertos += 1;
        }

        Intent pergunta06 = new Intent(this, Pergunta06.class);
        pergunta06.putExtra("acertos", acertos);
        pergunta06.putExtra("nome", nome);
        startActivity(pergunta06);
    }
