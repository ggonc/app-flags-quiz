...
public class Pergunta07 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNumeroPergunta.setText("7/10");
    ...
    public void responder(View view){
        ...
        if (radioButton.getText().equals("México")){
            acertos += 1;
        }

        Intent pergunta08 = new Intent(this, Pergunta08.class);
        pergunta08.putExtra("acertos", acertos);
        pergunta08.putExtra("nome", nome);
        startActivity(pergunta08);
    }
