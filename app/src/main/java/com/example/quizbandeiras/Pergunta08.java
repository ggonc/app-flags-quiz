...
public class Pergunta08 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNumeroPergunta.setText("8/10");
    ...
    public void responder(View view){
        ...
        if (radioButton.getText().equals("Holanda")){
            acertos += 1;
        }

        Intent pergunta09 = new Intent(this, Pergunta09.class);
        pergunta09.putExtra("acertos", acertos);
        pergunta09.putExtra("nome", nome);
        startActivity(pergunta09);
    }
