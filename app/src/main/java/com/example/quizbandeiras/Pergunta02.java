...
public class Pergunta02 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textNumeroPergunta.setText("2/10");
    ...
    public void responder(View view){
        ...
        if (radioButton.getText().equals("Panamá")){
            acertos += 1;
        }

        Intent pergunta03 = new Intent(this, Pergunta03.class);
        pergunta03.putExtra("acertos", acertos);
        pergunta03.putExtra("nome", nome);
        startActivity(pergunta03);
    }
